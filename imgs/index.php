            ...
            <div class="row">
                <div class="container-slider col-12">
                    <div class="row container-icons">
                      <a href="https://m.facebook.com/OficialSyllLek/" target="_blank"><div class="social-icons-slider fb-icon mr-2"></div></a>
      ...
      <div class="container-fluid" id="music">
        <div class="row">
          <div class="container-music col-12">
            <h1 class="text-center my-4 text-light">Música</h1>
            <div class="row d-none d-md-block">
              <div class="col-8 mx-auto mb-5">
                <div class="row">
                  <div class="col-6 text-center">
                      <iframe src="https://open.spotify.com/embed/track/6p8eFfPw3nQkf37aT3AkmK" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                  </div>
                  <div class="col-6 text-center my-auto">
                    <h3 class="text-light">Escute também no</h3>
                    <div class="">
                      <img src="imgs/Spotify-logo.png" class="mr-2 mb-4"> <br>
                      <img src="imgs/Deezer-Logo.png" class="mr-2 mb-4"> <br> 
            ...
            <div class="row">
                <div class="container-videos col-12">
                    ...
                    <div class="embed-responsive embed-responsive-16by9 col-8 mx-auto">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/MeGgH94dyTs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
